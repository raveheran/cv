...
\begin{rSubsection}
	...
	\item Led agile development cycles of HIPAA-compliant B2B chat and voice conversational AI SAAS solutions for\\\hspace*{.5cm}enterprise healthcare organizations that integrate with EHR and other systems.
	\item Collaborated with multidisciplinary teams to deliver innovative patient-facing capabilities, increasing adoption\\\hspace*{.5cm}rate by users and expanding the customer portfolio.
