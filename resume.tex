...
\begin{rSubsection}
	...
	\item \textbf{Dissertation}: Modeling Vocal Accommodation in Human-Computer Interaction for Integration \hspace*{3.4cm}into Spoken Dialogue Systems %\\\hspace*{.7cm}(supervisor: Dr.\ Ingmar Steiner)
...
\begin{rSubsection}
	...
	\item Developing and testing of NLP tools used for research %(by Prof.\ Christopher Culy)
