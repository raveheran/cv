...
\address{{\href{mailto:ravehe@gmail.com}{ravehe@gmail.com}}\quad|\quad\texttt{+}972 (0)50 218 7899}
...
\begin{rSubsection}
	...
	\item Led agile development cycles of patient-facing, HIPAA-compliant B2B SAAS conversational AI solutions for\\\hspace*{.5cm}enterprise healthcare organizations that integrate with EHR and other systems.
	\item Optimized user experience and engagement by tracking data-driven analytics, achieving up to 50\% call \\\hspace*{.5cm}automation rate for appointment management, prescription refills, etc.
	\item Evaluated and launched generative AI features with robust monitoring and control mechanisms, increasing\\\hspace*{.5cm}explainability and reducing hallucinations by 70\% in GPT-generated responses.
	\item Defined clear, traceable KPIs and shaped the product's roadmap by performing market research, meeting\\\hspace*{.5cm}clients, and working with cross-functional teams.
...
\begin{multicols}{2}
	...
	\end{tabular}\\[0.25cm]
	\footnotesize\textbf{Love gaming!} Recently played:\\
	Baldur's Gate 3, God of War Ragnarök, A Plague Tale: Requiem, Horizon: Forbidden West, Lost in Random, The Last of Us, \ldots
\end{multicols}
\end{rSection}
