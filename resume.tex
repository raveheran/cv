...
\begin{rSubsection}
	...
	\item Leading UX surveys and experiments to identify gaps in useability and user satisfaction
\end{rSubsection}
...
\begin{rSubsection}
	...
	\item Developing spoken dialogue systems and human-computer interaction applications for\\\hspace*{.7cm}public demonstrations and proof-of-concept research
	\item Investigating new solutions and approaches for using state-of-the-art conversational AI\\\hspace*{.7cm}technologies in every-day applications
\end{rSubsection}
...
\begin{rSubsection}
	...
	\item Specifying and developing analysis and visualization processes for text-to-speech platforms
...
\begin{rSubsection}
	...
	\item Implementing automation processes for software testing and specifications management
...
\begin{rSection}{Community}
	\begin{tabular}{l}
		...
		Reviewer: EMNLP 2021, COLING 2020, SpeCom 2020, LREC 2020, Interspeech 2019
	\end{tabular}
\end{rSection}
