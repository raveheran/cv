...
\begin{rSubsection}
	...
	\item Led agile development cycles of patient-facing, HIPAA-compliant B2B web, mobile,  and voice conversational \\\hspace*{.5cm}AI solutions for enterprise healthcare organizations that integrate with EHR and other systems.
	\item Optimized user experience and engagement by leveraged NLP and ML data analyses, achieving up to \\\hspace*{.5cm}50\% call automation rate for appointment management, prescription refills, etc.
...
\begin{rSection}{Languages}
	...
	\begin{tabular}{ @{} >{\bfseries}l @{\hspace{3ex}} l @{\hspace{6ex}} @{} >{\bfseries}l @{\hspace{3ex}} l @{\hspace{6ex}}  @{} >{\bfseries}l @{\hspace{3ex}} l}
		...
		Arabic	&	Beginner			&	Japanese	& Beginner
	\end{tabular}
