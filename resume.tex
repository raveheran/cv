...
\begin{rSection}{Research Statement}
	My main research focuses on phonetic accommodation in human-computer interaction.	
	This includes a computational model for capturing, tracking, and generating accommodation behaviors.
	This model was integrated into a dedicated end-to-end, web-based spoken dialogue system with customizable components and visualizations of the states and changes of defined phonetic features.
	
	Additionally, I investigated how phonetic convergence can be utilized in conversation analysis.
	For example, one work examined the differences between human-directed speech and computer-directed speech in different human-human-computer scenarios with an Amazon Alexa device.
	A follow-up work looked into the influence of a second human speaker on participants’ speech toward Alexa.
	Other works dealt with modeling accommodation in real-world, high-stakes sales conversations to characterize effectiveness of different speaker behaviors.
	
	In order to expand my knowledge and experience more industry atmosphere, I would like to do an internship, which will preferably combine research and technical work.
	A project could further investigate accommodation modeling, experiment with real-time phonetic changes in TTS, or a combine both.
	However, I am open to discuss any other related directions as well.
...
\begin{rSubsection}
	...
	\item Defining processes for designing, developing, and delivering software components and\\\hspace*{.7cm}new features for a conversation AI platform
	\item Facing customers to identify opportunities and technical gaps
	\item Specifying and implementing tools for customer journey analysis
\end{rSubsection}
