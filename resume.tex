...
\begin{rSubsection}
	{Manual and Automated Software Tester}
	{2010 -- 2012}
	{Qualitest (at GE Healthcare)}
	{Tirat Carmel, Israel}
	
	\setlength{\itemindent}{.5cm}
	
	\item Developed automation processes for software testing and DICOM standard to support R\&D teams.
	\item Managed, wrote, and performed testing plans for ultrasound machines software.
\end{rSubsection}
