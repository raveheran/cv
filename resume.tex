...
\begin{rSubsection}
	...
	\item \textbf{Dissertation}: Modeling Vocal Accommodation in Human-Computer Interaction and Integration \hspace*{3.4cm}into Spoken Dialogue Systems %\\\hspace*{.7cm}(supervisor: Dr.\ Ingmar Steiner)
