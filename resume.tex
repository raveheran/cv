...
\address{{\url{ravehe@gmail.com}}\quad|\quad\texttt{+}972 (0)50 218 7899}
...
\begin{rSubsection}
	{Product Management \footnotesize{\textit{(final grade: 90)}}}
	{2022}
	{Technion}
	{Haifa, Israel}
	...
	\item *** learned PMing principals ***
	\item *** practical exercises and assignments ***
\end{rSubsection}
...
\begin{rSubsection}
	...
	\item \textbf{Dissertation}: Vocal Accommodation in Human-Computer Interaction:\\\hspace*{3.3cm}Modeling and Integration into Spoken Dialogue Systems %\\\hspace*{.7cm}(supervisor: Dr.\ Ingmar Steiner)
...
\begin{rSubsection}
	...
	\item Led agile development cycles of patient-facing, HIPAA-compliant chat and voice conversational AI\\\hspace*{.7cm}solutions for enterprise healthcare organizations that integrates with EHR and other systems.
	
	\item Optimized user experience and engagement by leveraged data-driven NLP and ML analyses,\\\hspace*{.7cm}achieving up to 50\% call automation rate for appointment management, prescription refills, etc.
	
	\item Evaluated and launched LLM-based features, including robust monitoring and control mechanisms,\\\hspace*{.7cm}increasing explainability and reducing hallucinations by 70\% in GPT-generated responses.
	
	\item Improved product-market fit and shaped the product's roadmap by performing market research,\\\hspace*{.7cm}meeting clients, and working with cross-functional teams.
...
\begin{rSubsection}
	...
	\item Defined processes for designing, developing, and delivering software components and\\\hspace*{.7cm}new features for a conversation AI platform
	\item Faced customers to identify opportunities and technical gaps
	\item Specified and implemented tools for customer journey analysis
\end{rSubsection}
...
\begin{rSubsection}
	...
	\item Designed and implemented phoneme-based processing for the neural multilingual\\\hspace*{.7cm}Tacotron-based text-to-speech component of a voice assistant
	\item Analyzed and optimized training and real-time performance, leading to an improvement\\\hspace*{.7cm}of overall speech output quality and more learning
\end{rSubsection}
...
\begin{rSubsection}
	...
	\item Developed spoken dialogue systems and human-computer interaction applications for\\\hspace*{.7cm}demonstrations and proof-of-concept research
...
\begin{rSubsection}
	...
	\item Created NLP resources and algorithms for multilingual speech synthesis
	\item Developed analysis and visualization tools for text-to-speech platforms
\end{rSubsection}
