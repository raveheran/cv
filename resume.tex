...
\begin{rSubsection}{Universität des Saarlandes}{\textsc{Apr} 2016 -- Present}{Ph.D.\ in Computational Linguistics}{Saarbrücken, Germany} %(with )}
	...
	\item \textbf{\underline{Dissertation}}: Integrating of convergence capabilities into spoken dialogue systems \\\hspace*{.7cm}(supervisor: Dr.\ Ingmar Steiner)
...
\begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
	...
	Tools \& Frameworks & CoreNLP, Theano, Praat, OpenDial, IrisTK, git, Gradle, LaTeX
\end{tabular}
...
\begin{rSection}{Languages}
	...
	\begin{tabular}{ @{} >{\bfseries}l @{\hspace{3ex}} l @{\hspace{6ex}} @{} >{\bfseries}l @{\hspace{3ex}} l @{\hspace{6ex}}  @{} >{\bfseries}l @{\hspace{6ex}} l}
