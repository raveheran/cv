...
\begin{rSubsection}
	...
	\item Led agile development cycles of patient-facing, HIPAA-compliant B2B chat and voice conversational AI\\\hspace*{.5cm}self-service SAAS solutions for enterprise healthcare organization.
	\item Owned the integrations to Epic and other EHRs, ticketing systems, analytics data streams, and integration \\\hspace*{.5cm}management platform, enabling reaching various customer profiles and support required capabilities.
	\item Built and prioritized integration roadmap, needs discovery with clients, requirements definition, iterative\\\hspace*{.5cm}design with R\&D, and providing relevant materials to GTM teams.
	\item Strategized and launched LLM-based Generative AI features with robust monitoring and control\\\hspace*{.5cm}mechanisms, increasing explainability and reducing hallucinations by 70\% in GPT-generated RAG responses.
	\item Optimized user experience and engagement by defining and tracking KPIs and leveraging data-driven analyses,\\\hspace*{.5cm}achieving up to 50\% call automation rate for various patient tasks.
...
\begin{rSubsection}
	...
	\item Designed and implemented various integrations for scalability and quality and maintained their documentation.
