...
\begin{rSubsection}
	...
	\item Optimized user experience and engagement by defining and tracking KPIs while leveraging data-driven\\\hspace*{.5cm}analyses, conducting customer interviews, and focus group insights.
	...
	\item Improved product-market fit and shaped the product's roadmap by conducting market research, user testing,\\\hspace*{.5cm}working with cross-functional teams, and participating in international conferences.
...
\begin{rSubsection}
	...
	\item Developed multilingual, cross-cultural human-computer interaction proof-of-concept applications, showcasing\\\hspace*{.5cm}novel ideas and approaches for improving user experience, engagement, and trust.
...
%		\item Integrated M.Sc.\ in Speech Technology
		\item Conducted experiment with human participants and carried out various qualitative and quantitative analyses.
		\item Authored, co-authored, and presented peer-reviewed academic work on spoken dialogue systems worldwide.
	\end{rSubsection}
