...
\begin{rSubsection}
	...
	\item Optimized user experience and engagement by tracking KPIs and leveraging data-driven analyses, achieving \\\hspace*{.5cm}up to 50\% call automation rate for appointment management, prescription refills, etc.
...
\begin{rSubsection}
	...
	\item Designed and implemented NLP, generative AI, and speech processing features for an AI assistant.
	...
	\item Conducted user testing and customer sessions to identify opportunities and provide roadmap insights.
\end{rSubsection}
