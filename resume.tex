...
\address{\url{ravehe@gmail.com}} % Your secondary addess (optional)
...
\begin{rSubsection}{Universität des Saarlandes}{\textsc{Apr} 2016 -- Present}{Ph.D.\ in Computational Linguistics}{Saarbrücken, Germany} %(with )}
	...
	\item \textbf{\underline{Dissertation}}: Integration of Convergence Capabilities into Spoken Dialogue Systems \\\hspace*{.7cm}(supervisor: Dr.\ Ingmar Steiner)
