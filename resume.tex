...
\begin{rSubsection}{Speech Scientist Intern}{\textsc{Jan} 2020 -- \textsc{Apr} 2020}{Fraunhofer IIS}{Erlangen, Germany}
	\setlength{\itemindent}{.7cm}
	
	\item Development Work on deep neural text-to-speech components of a larger voice assistant project
	\item Research work with a Tacotron-based system
