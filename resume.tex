...
\begin{rSubsection}
	...
	\item Led agile development of patient-facing, HIPAA-compliant B2B web, mobile, and voice conversational \\\hspace*{.5cm}AI SAAS solutions for enterprise healthcare organizations that integrate with EHR and other systems.
	\item Owned projects involving full software development life cycle with cross-functional groups and coordinated \\\hspace*{.5cm}with technical, R\&D, and GTM teams on customer deployments from discovery to to-live.
	\item Optimized user experience and engagement on the client web platform by defining relevant KPIs \\\hspace*{.5cm}data-driven analyses, achieving up to 50\% call automation rate for various patient tasks.
...
\begin{rSubsection}
	...
	\item Worked closely with Product and UX designers on customer-facing initiatives to increase engagement.
	\item Conducted customer sessions to identify opportunities and technical gaps to provide roadmap decision insights.
...
%		\item Exercised practical hands-on projects including product strategy and client-facing presentations.
	...
	\begin{rSubsection}
		{Ph.D.\ in Computational Linguistics \footnotesize{\textit{(magna cum laude)}}}
		{2016 -- 2020}
...
\begin{multicols}{2}
	...
	Jira, Notion, Confluence, Looker, Git\\VoiceFlow, Praat, Gradle, \LaTeX\\
