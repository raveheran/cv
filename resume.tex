...
\begin{tabular}{ @{} >{\bfseries}l @{\hspace{3ex}} l }
	Programming Languages 	& \underline{Experienced in}: Python, Java, R\\
						  	& \underline{Familiar with}: JavaScript, SQL, VB, Groovy, DOS-batch\\[0.2cm]
	Tools \& Frameworks   	& Jira, Figma, Git, Looker, Praat, VoiceFlow, DialogFlow, spaCy, Gradle, \LaTeX\\
\end{tabular}
...
\begin{rSection}{Languages}
	...
	\begin{tabular}{ @{} >{\bfseries}l @{\hspace{2ex}} l @{\hspace{6ex}} @{} >{\bfseries}l @{\hspace{2ex}} l @{\hspace{6ex}}  @{} >{\bfseries}l @{\hspace{2ex}} l}
