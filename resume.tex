...
\begin{rSubsection}
	...
	\item Optimized user experience and engagement by leveraging KPIs and BI tools, achieving up to \\\hspace*{.5cm}50\% call automation rate for appointment management, prescription refills, etc.
