...
\begin{rSubsection}
	...
	\item Bootstrapped the Explainability and Control mindset across R\&D teams, leading to customer adoption of\\\hspace*{.5cm}trustworthy Generative AI features.
	\item Strategized go-to-market and launched LLM-based Generative AI features with robust monitoring and control\\\hspace*{.5cm}mechanisms, increasing explainability and reducing hallucinations by 70\% in GPT-generated RAG responses.
	\item Optimized user experience and engagement by defining and tracking KPIs and leveraging data-driven analyses,\\\hspace*{.5cm}achieving up to 50\% call automation rate for appointment and prescription management.
